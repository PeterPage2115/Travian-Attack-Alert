...
const SRC_ALLOWLIST = [
  ...
  'src/envelope.js', 'src/lease.js', 'src/lifecycle.js',
...
const ALLOWED_DEPS = {
  ...
  'src/discord.js': ['src/runtime-api.js'],
  'src/dispatch.js': ['src/runtime-api.js'],
  'src/envelope.js': ['src/runtime-api.js'],
  'src/lease.js': ['src/runtime-api.js'],
  'src/lifecycle.js': [],
  ...
  'src/runtime.js': [],
  'src/snapshot.js': ['src/runtime-api.js'],
  'src/storage.js': ['src/runtime-api.js'],
  'src/text.js': [],
