...
const ALLOWED_DEPS = {
  ...
  'src/constants.js': [],
  'src/diagnostics.js': ['src/diagnostics-impl.js', 'src/runtime.js'],
  ...
  'src/panel.js': ['src/panel-impl.js', 'src/runtime.js'],
  'src/panel-impl.js': ['src/adapters.js', 'src/constants.js'],
  'src/parser-impl.js': ['src/text.js'],
  'src/parser.js': ['src/parser-impl.js'],
  'src/route.js': [],
  'src/runtime-api.js': ['src/storage.js', 'src/lease.js', 'src/parser.js', 'src/snapshot.js',
    'src/envelope.js', 'src/migration.js', 'src/discord.js', 'src/transport.js',
    'src/dispatch.js', 'src/conservation.js', 'src/diagnostics.js', 'src/panel.js',
    'src/acquisition.js'],
  'src/runtime.js': [],
